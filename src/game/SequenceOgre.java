...
public class SequenceOgre extends SequenceMonster {

    /**
     * The range that the ogre must be in
     * in order to attack the player
     */
    private static final double OGRE_ATTACK_DISTANCE = 100;

    /**
     * An array list that holds all the frames
     * of the ogre's attack animation
     */
    private static final ArrayList<Image> ATTACK_SEQUENCE = new ArrayList<Image>(
            Arrays.asList(
                    new Image("resources/Monsters/Ogre/OgreAttackF1.png"),
                    new Image("resources/Monsters/Ogre/OgreAttackF2.png")
            )
    );
     ...
     * which frame of the ogre to display on the game screen
     */
     ...
     */
    public SequenceOgre() {
        super(generateImageView("resources/Monsters/Ogre/OgreStatic.png"));
    }
        ...
        AnimationTimer attackLoop = new AnimationTimer() {
            ...
            public void handle(long l) {
                if (gameScreen.monster != null && !gameScreen.monster.isDead()) {
                    ...
                    if (deltaX < OGRE_ATTACK_DISTANCE && deltaX > -OGRE_ATTACK_DISTANCE) {
                    ...
                    if (deltaY < OGRE_ATTACK_DISTANCE && deltaY > -OGRE_ATTACK_DISTANCE) {
                    ...
                    if (deltaY < OGRE_ATTACK_DISTANCE
                            && deltaY > -OGRE_ATTACK_DISTANCE
                            && deltaX < OGRE_ATTACK_DISTANCE
                            && deltaX > -OGRE_ATTACK_DISTANCE) {
